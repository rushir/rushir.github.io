...
window.Rainbow = function() {
    ...
    function s(a, b) {
        return '<span class="' + a.replace(/\./g, " ") + (m ? " " + m : "") + '">' + b + "</span>"
    }
    function t(a, b, c, i) {
        var e = a.exec(c);
        if (e) {
            ...
            var l = e[0], g = e.index, v = e[0].length + g, h = function() {
                function e() {
                    t(a, b, c, i)
                }
            ...
            if (D(g, v))
                ...
                var n = w(b.matches), m = function(a, c, i) {
                    if (a >= c.length)
                        i(l);
                    else {
                        var d = e[c[a]];
                        if (d) {
                            ...
                            g.matches: g, j = function(b, d, g) {
                                ...
                                for (h = 1; h < c[a]; ++h)
                                    e[h] && (f = f + e[h].length);
                                d = g ? s(g, d) : d;
                                l = l.substr(0, f) + l.substr(f).replace(b, d);
                                m(++a, c, i)
                            };
                            f ? o(d, f, function(a) {
                                j(d, a)
                            }) : typeof g === "string" ? j(d, d, g) : x(d, h.length ? h : [h], function(a) {
    ...
    function x(a, b, c) {
        function i(b, l) {
            l < b.length ? t(b[l].pattern, b[l], a, function() {
                i(b, ++l)
            }) : E(a, function(a) {
                delete j[d];
                delete f[d];
    ...
    function E(a, b) {
        function c(a, b, i, f) {
            if (i < b.length) {
                ++y;
                var h = b[i], m = j[d][h], a = a.substr(0, h) + a.substr(h).replace(m.replace, m["with"]), h = function() {
                    c(a, b, ++i, f)
                };
                0 < y%250 ? h() : setTimeout(h, 0)
            } else 
                f(a)
        }
        var i = w(j[d]);
    ...
    function p(a, b, c) {
        if (b < a.length) {
            var d = a[b], e = C(d);
            return !( - 1 < (" " + d.className + " ").indexOf(" rainbow ")) && e ? (e = e.toLowerCase(), d.className += d.className ? " rainbow" : "rainbow", o(d.innerHTML, e, function(l) {
                d.innerHTML = l;
                j = {};
                f = {};
                q && q(d, e);
    ...
    var j = {}, f = {}, n = {}, A = {}, d = 0, z = 0, u = 0, y = 0, m, q;
    return {
