/*
   ...
   ommmmdo:.          ommmmdo:.                                         ./smmmmm/
   ommmms             ommmms                                               hmmmm/
   ommmms             ommmms                                               hmmmm/
   ommmms  `:`        ommmms          `:ss`           `.+y/          `./   hmmmm/
   ommmms  .mms/`     ommmms       .+ymmmmh.       `:ohmmmmo      `:ohmd   hmmmm/
   ommmms  .mmmmm`    ommmms     .ymmmsdmmmd:     :dmmmsmmmmy`    :mmmmd   hmmmm/
   ommmms  .mmmmm`    ommmms     smmmm:.hmmmm:   `mmmmd /mmmmh`   :mmmmd   hmmmm/
   ommmms  .mmd+.     ommmms     ymmmm: `smy-    `mmmmd  -dmo`    :mmmmd   hmmmm/
   ommmms  .m/        ommmms     ymmmm/.. .      `mmmmd...``      :mmmmd   hmmmm/
   ommmms  .mmo.      ommmms     ymmmmmy-        `mmmmmd+`        :mmmmd   hmmmm/
   ommmms  .mmmmo     ommmms     ymmmm/          `mmmmm`          :mmmmd   hmmmm/          .
   ommmmd/ .mmmmm`    ommmms     ommmmy.`+h/`     dmmmm/ -yy-     :mmmmd `+mmmmm/        -ymh:
   -hmmmmmh+mmmh/     ommmmy     `hmmmmddmmmh-    /mmmmmdmmmms`   `+dmmd+dmmmmmy.      :ymmmmmh:
    `:hmmmmmmh/`      :dmmmmh:    `/hmmmmmmy:      .odmmmmmdo.      `+dmmmmmms-       `+dmmmmmmo`
      `:ymmh:`         `+dmms.      `/hmmy:`         .odmdo.          `+dmms-           .+dmmo.
        `::`             `/.          `/-              ./.              `/-               ./.
...
$(document).ready(function() {
    ...
    if(iPhone){
        $("#bleed-logo").css({ 'top': '15px', 'left':'15px' });
        $("#contact").remove();
        $("#contact-iphone").css("display", "block");
        $("#bleed-logo").css("opacity", "1");
        $("#bleed-logo:hover").css("opacity", "1");
    }

    if(iPad){
        $("#bleed-logo").css({ 'top': '55px', 'left':'55px' });
        $("#handwriting-menu").css({ 'top': '35px', 'left':'10px' });
        $("ul#clients").css("margin-bottom", "150px");
    }
    ...
    function activateMenu(){
        ...
        $("#bleed-logo img").attr("src", "img/bleed-logo-white-retina.png");
    ...
    function disableMenu(){
        ...
        $("#bleed-logo img").attr("src", "img/bleed-logo-black-retina.png");
    ...
    function switchToBlack(){
        ...
        $("#bleed-logo img").attr("src", "img/bleed-logo-white.png");
